...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, PacketLearningModding> {
    ...
    public void registerPackets() {
        ...
        registerPacket(PacketMachineInterfaceGui.class);
        registerPacket(PacketSpaceshipBomb.class);
        registerPacket(PacketCakeButtonGui.class);
    }
    ...
    protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg, List<Object> out) throws Exception {
        ...
        Class<? extends PacketLearningModding> clas = packets.get(discriminator);
        if (clas == null) {
            throw new NullPointerException("No packet registered for discriminator: " + discriminator);
        }

        PacketLearningModding pkt = clas.newInstance();
    ...
    public void postInitialise() {
        ...
        isPostInit = true;
        Collections.sort(packets, new Comparator<Class<? extends PacketLearningModding>>() {

            @Override
            public int compare(Class<? extends PacketLearningModding> clazz1, Class<? extends PacketLearningModding> clazz2) {
    ...
    public void sendToAll(PacketLearningModding message) {
     ...
     */
    public void sendTo(PacketLearningModding message, EntityPlayerMP player) {
     ...
     */
    public void sendToAllAround(PacketLearningModding message, NetworkRegistry.TargetPoint point) {
     ...
     */
    public void sendToDimension(PacketLearningModding message, int dimensionId) {
