...
public class Recipies {
    ...
    public static void initVanilla() {
        ...
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubyWand), new Object[]{"  X", " / ", "/  ", 'X', new ItemStack(ModItems.items, 1, 0), '/', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubySword), new Object[]{" X ", " X ", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubyPickaxe), new Object[]{"XXX", " S ", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubySpade), new Object[]{" X ", " S ", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubyAxe), new Object[]{" XX", " SX", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubyAxe), new Object[]{"XX ", "XS ", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubyHoe), new Object[]{" XX", " S ", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
        CommonProxy.addShapedRecipe(new ItemStack(ModItems.rubyHoe), new Object[]{"XX ", " S ", " S ", 'X', new ItemStack(ModItems.items, 1, 0), 'S', Items.stick});
